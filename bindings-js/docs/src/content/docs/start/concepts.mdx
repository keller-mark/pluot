...
<Aside type="note" title="Note">This timeout mechanism is an implementation detail that is subject to change; we are exploring alternative approaches to rendering-while-loading-data.</Aside>
