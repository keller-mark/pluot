...
if [[ "$1" != "--action" ]]; then
  ...
  then
      echo "Requires the GitHub CLI (gh)." >&2
      exit 1
  fi
fi
...
# Temporarily copy the root README.md to crates/pluot/pkg/README.md,
# since the file at crates/pluot/pkg will be shown for the main 'pluot'
# package on NPM.
#mv ./crates/pluot/pkg/README.md ./crates/pluot/pkg/README.temp.md
#cp ./README.md ./crates/pluot/pkg/README.md
...
# TODO: Publish python package to PyPI, but only when not --action?
