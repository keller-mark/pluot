...
To mitigate this, Pluot can compress the SVG string (currently using the LZ-string method), but this also has a performance cost and only partially mitigates the issue.
In our experience:
