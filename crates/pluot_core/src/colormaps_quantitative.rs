...
pub fn blues(x: f32) -> Rgba {
    let v0 = [0.9686274509803922, 0.984313725490196, 1.0, 1.0];
    let v1 = [0.8705882352941177, 0.9215686274509803, 0.9686274509803922, 1.0];
    let v2 = [0.7764705882352941, 0.8588235294117647, 0.9372549019607843, 1.0];
    let v3 = [0.6196078431372549, 0.792156862745098, 0.8823529411764706, 1.0];
    let v4 = [0.4196078431372549, 0.6823529411764706, 0.8392156862745098, 1.0];
    let v5 = [0.25882352941176473, 0.5725490196078431, 0.7764705882352941, 1.0];
    let v6 = [0.12941176470588237, 0.44313725490196076, 0.7098039215686275, 1.0];
    let v7 = [0.03137254901960784, 0.3176470588235294, 0.611764705882353, 1.0];
    let v8 = [0.03137254901960784, 0.18823529411764706, 0.4196078431372549, 1.0];
    max4(
...
pub fn greens(x: f32) -> Rgba {
    let v0 = [0.9686274509803922, 0.9882352941176471, 0.9607843137254902, 1.0];
    let v1 = [0.8980392156862745, 0.9607843137254902, 0.8784313725490196, 1.0];
    let v2 = [0.7803921568627451, 0.9137254901960784, 0.7529411764705882, 1.0];
    let v3 = [0.6313725490196078, 0.8509803921568627, 0.6078431372549019, 1.0];
    let v4 = [0.4549019607843137, 0.7686274509803922, 0.4627450980392157, 1.0];
    let v5 = [0.2549019607843137, 0.6705882352941176, 0.36470588235294116, 1.0];
    let v6 = [0.13725490196078433, 0.5450980392156862, 0.27058823529411763, 1.0];
    let v7 = [0.0, 0.42745098039215684, 0.17254901960784313, 1.0];
    let v8 = [0.0, 0.26666666666666666, 0.10588235294117647, 1.0];
    max4(
        segment(0.0, v0, 0.13, v1, x),
        max4(
            segment(0.13, v1, 0.25, v2, x),
...
pub fn oranges(x: f32) -> Rgba {
    let v0 = [1.0, 0.9607843137254902, 0.9215686274509803, 1.0];
    let v1 = [0.996078431372549, 0.9019607843137255, 0.807843137254902, 1.0];
    let v2 = [0.9921568627450981, 0.8156862745098039, 0.6352941176470588, 1.0];
    let v3 = [0.9921568627450981, 0.6823529411764706, 0.4196078431372549, 1.0];
    let v4 = [0.9921568627450981, 0.5529411764705883, 0.23529411764705882, 1.0];
    let v5 = [0.9450980392156862, 0.4117647058823529, 0.07450980392156863, 1.0];
    let v6 = [0.8509803921568627, 0.2823529411764706, 0.00392156862745098, 1.0];
    let v7 = [0.6509803921568628, 0.21176470588235294, 0.011764705882352941, 1.0];
    let v8 = [0.4980392156862745, 0.15294117647058825, 0.01568627450980392, 1.0];
    max4(
        segment(0.0, v0, 0.13, v1, x),
        max4(
            segment(0.13, v1, 0.25, v2, x),
...
pub fn purples(x: f32) -> Rgba {
    let v0 = [0.9882352941176471, 0.984313725490196, 0.9921568627450981, 1.0];
    let v1 = [0.9372549019607843, 0.9294117647058824, 0.9607843137254902, 1.0];
    let v2 = [0.8549019607843137, 0.8549019607843137, 0.9215686274509803, 1.0];
    let v3 = [0.7372549019607844, 0.7411764705882353, 0.8627450980392157, 1.0];
    let v4 = [0.6196078431372549, 0.6039215686274509, 0.7843137254901961, 1.0];
    let v5 = [0.5019607843137255, 0.49019607843137253, 0.7294117647058823, 1.0];
    let v6 = [0.41568627450980394, 0.3176470588235294, 0.6392156862745098, 1.0];
    let v7 = [0.32941176470588235, 0.15294117647058825, 0.5607843137254902, 1.0];
    let v8 = [0.24705882352941178, 0.0, 0.49019607843137253, 1.0];
    max4(
        segment(0.0, v0, 0.13, v1, x),
        max4(
            segment(0.13, v1, 0.25, v2, x),
...
pub fn reds(x: f32) -> Rgba {
    let v0 = [1.0, 0.9607843137254902, 0.9411764705882353, 1.0];
    let v1 = [0.996078431372549, 0.8784313725490196, 0.8235294117647058, 1.0];
    let v2 = [0.9882352941176471, 0.7333333333333333, 0.6313725490196078, 1.0];
    let v3 = [0.9882352941176471, 0.5725490196078431, 0.4470588235294118, 1.0];
    let v4 = [0.984313725490196, 0.41568627450980394, 0.2901960784313726, 1.0];
    let v5 = [0.9372549019607843, 0.23137254901960785, 0.17254901960784313, 1.0];
    let v6 = [0.796078431372549, 0.09411764705882353, 0.11372549019607843, 1.0];
    let v7 = [0.6470588235294118, 0.058823529411764705, 0.08235294117647059, 1.0];
    let v8 = [0.403921568627451, 0.0, 0.050980392156862744, 1.0];
    max4(
        segment(0.0, v0, 0.13, v1, x),
        max4(
            segment(0.13, v1, 0.25, v2, x),
...
pub fn sample(colormap: QuantitativeColormap, x: f32) -> Rgba {
    match colormap {
        ...
        QuantitativeColormap::Blues => blues(x),
        QuantitativeColormap::Greens => greens(x),
        QuantitativeColormap::Oranges => oranges(x),
        QuantitativeColormap::Purples => purples(x),
        QuantitativeColormap::Reds => reds(x),
    }
}
...
mod tests {
    ...
    fn endpoints_match_control_points() {
        ...
        assert_eq!(blues(0.0), [0.9686274509803922, 0.984313725490196, 1.0, 1.0]);
        assert_eq!(blues(1.0), [0.03137254901960784, 0.18823529411764706, 0.4196078431372549, 1.0]);
    }
    ...
    fn sample_dispatches_to_matching_function() {
        ...
        assert_eq!(sample(QuantitativeColormap::Reds, 0.5), reds(0.5));
    }
}
