...
You will likely get better performance by using WebGPU directly via JavaScript; that is not the goal of this project. The question is whether the performance of this "headless" approach is good enough, and whether the benefits are worth the potential performance tradeoffs.
