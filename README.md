...
|  |  |  |
| :---: | :---: | :---: |
| **Static or interactive plots**<br><sub>Bitmap or vector graphics</sub><br><br>![Static plots](./.github/img/static.png) | **Web-based plots**<br><sub>Scalable to millions of points</sub><br><br>![Web-based plots](./.github/img/web1.png)<br><br>[Open example](https://pluot.dev/examples/scatterplot-dynamic-opacity/) | **Python notebooks**<br><sub>Render static plots or use interactive widget built with Anywidget</sub><br><br>![Python notebooks](./.github/img/marimo.png)<br><br>[View source](https://github.com/keller-mark/pluot/tree/main/bindings-python/notebooks) |
